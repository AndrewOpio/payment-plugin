...
class ExternalConfiguration
{
        ...
        function __construct()
        {
                ...
                //$this->merchantID = get_option( 'merchant_id' );
                //$this->apiKeyID = get_option( 'publishable_key' );
                //$this->secretKey = get_option( 'private_key' );
                ...
                $this->merchantID = "abu_asterisk_0982207_ugx";
                $this->apiKeyID = "bd2c5928-c616-419c-83a1-fbd4c46d3af2";
                $this->secretKey = "Ii+OQe9iNFPpTPxZMM/WVT/izSTdrIEqEfJoVqlXRTI=";
